...
class FactoryEnvCfg(DirectRLEnvCfg):
    decimation = 8
    render_interval = 8  # match decimation to avoid redundant renders
    action_space = 6
    ...
    episode_length_s = 300.0  # Long enough for demo recording (overridden by task cfg)
...
class FactoryTaskPegInsertCfg(FactoryEnvCfg):
    ...
    task = PegInsert()
    episode_length_s = 300.0  # long enough for demo
