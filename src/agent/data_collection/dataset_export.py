...
from src.agent.data_collection.config import RobotSimConfig, load_robot_config
from src.agent.data_collection.sim_recorder import _coerce_goal_joint
...
def load_adc_export_context(
    *,
    ...
    from src.agent.data_collection.adc_imports import (
        get_adc_root,
