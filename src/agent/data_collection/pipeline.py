...
class DataCollectionPipeline:
    ...
    def _generate_collection_runner(self) -> Path:
        ...
        script = textwrap.dedent(f'''\
            ...
            sys.path.insert(0, "{(PROJECT_ROOT / 'src' / 'agent' / 'data_collection' / 'cap_runtime').resolve()}")

            from isaaclab.envs import ManagerBasedRLEnv
            from isaaclab.sensors import FrameTransformerCfg
            from isaaclab.sensors.frame_transformer.frame_transformer_cfg import OffsetCfg
            from src.agent.data_collection.pipeline import apply_task_top_camera_override
            ...
            from src.agent.data_collection.pipeline import classify_texture_asset_path, should_preserve_textured_usd
            ...
            from src.agent.data_collection.sim_camera import SimCamera, MultiCameraManager, inject_cameras_into_scene, SceneCameraManager
            from src.agent.data_collection.sim_recorder import SimRecorder, RecorderStorageError
            ...
            from src.agent.data_collection.textured_usd_spawn import spawn_textured_usd_with_child_physics
            from src.agent.data_collection.cap_artifacts import (
            ...
            from src.agent.data_collection.cap_generator import SimCaPGenerator, is_supported_tabletop_task, select_cap_profile
            ...
            from src.agent.data_collection.sim_judge import SimJudge
            ...
            def main():
                ...
                try:
                    if robot_cfg.name == "ur10e" and not using_local_ur10e_asset:
                        from src.agent.data_collection.ur10e_patches import ensure_ur10e_pad_collisions
