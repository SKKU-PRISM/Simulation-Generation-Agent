...
<p align="center">
  ...
  <a href="README.md"><img src="https://flagcdn.com/24x18/de.png" width="20" alt="Deutsch"> Deutsch</a>
</p>
...
├── LICENSE                       # MIT-Lizenz
├── src/main.py                   # Haupt-Einstiegspunkt (CLI-Modus)
├── src/tui/                      # Interaktives TUI-Dashboard (Textual)
├── scripts/
