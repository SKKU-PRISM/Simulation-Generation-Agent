...
DEFAULT_URDF = Path(
    "/home/vpraise/workspace/isaac-sim/standalone_examples/api/isaacsim.robot.manipulators/ur10e/rmpflow/ur10e.urdf"
)
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "assets" / "robots" / "ur10e_robotiq_2f85"


parser = argparse.ArgumentParser(description=__doc__)
parser.add_argument("--urdf", type=Path, default=DEFAULT_URDF, help="Source URDF with the 2F-85 gripper baked in")
